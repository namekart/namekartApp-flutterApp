...
import '../../change_notifiers/customSyncWidget.dart';
...
class _LiveDetailsScreenState extends State<LiveDetailsScreen>
  ...
  void initState() {
    ...
    fetchDataByDate(todayDate.formattedDate);
    ...
    FCMHelper().unsubscribeFromTopic("godaddy");
  ...
  void fetchDataByDate(String datetime){
  ...
  void configureGotoNextDayButton(bool wantToFetchDataByDate) {
    setState(() {
      ...
      if (wantToFetchDataByDate) {
        fetchDataByDate(calenderSelectedDate.formattedDate);
      }
                                ...
                                return VisibilityDetector(
                                  ...
                                  onVisibilityChanged: (info) async {
                                    if (info.visibleFraction==1.0) {
                                      ...
                                      final itemId = auctions[index]['id'].toString();
                                      final path = '$hiveDatabasePath~$itemId';
                                                      ...
                                                      Container(
                                                        ...
                                                        child: Wrap(
                                                          ...
                                                          children: buttons.map((buttonData) {
                                                            final button = buttonData.values.first
                                                            as Map<dynamic, dynamic>;
                                                            final buttonText = button['button_text'] as String;

                                                            return Bounceable(
                                                              onTap: ()async{
                                                                await dynamicDialog(context, button, widget.subCollection, auctionItem['id'].toString(), int.parse(buttonData.keys.toList()[0].toString().replaceAll("button", ""))-1, buttonData.keys.toList()[0]);
                                                              },
                                                              child: Padding(
